...
RULE TWINLC-VR-001 TYPE FORBIDDEN
WHEN FORWARD_TRANSITION_REQUESTED AND TARGET_STAGE != NEXT_DECLARED_STAGE
DO REPORT CODE "TWINLC-SEQUENCE-001" WHEN BLUEPRINT_DECLARES_SKIP_AHEAD
DO REPORT CODE "TWINLC-TRANSITION-001" WHEN REQUEST_SKIPS_AHEAD
FORBID ADVANCE_STAGE

RULE TWINLC-VR-002 TYPE REQUIRED
WHEN FEEDBACK_TRANSITION_REQUESTED
DO REQUIRE TARGET_STAGE IN REPEATABLE_EARLIER_STAGES AND CURRENCY_LOST
FORBID INFER_LATER_FACT_FROM_EARLIER_FACT
FORBID TREAT_EVALUATED_GRANT_AS_APPLY_AUTHORITY
```
